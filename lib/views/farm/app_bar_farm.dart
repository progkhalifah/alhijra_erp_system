...
class CustomeAppBarFarmManager extends StatelessWidget {
  const CustomeAppBarFarmManager({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var role_name_farm = "مدير مزرعة";

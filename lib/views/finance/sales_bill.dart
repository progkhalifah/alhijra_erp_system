...
class SalesBillPage extends StatelessWidget {
  SalesBillPage({Key? key}) : super(key: key);
                ...
                Row(
                  children: const [
                    ...
                    Padding(
                      ...
                      child: Text("فاتورة مبيعات", style: TextStyle(color: titleColor), ),
                    )
                  ],
                ),
                SizedBox(height: 20,),

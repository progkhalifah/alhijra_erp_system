...
class PurchasesReturnedPage extends StatelessWidget {
  PurchasesReturnedPage({Key? key}) : super(key: key);
              ...
              children: [
                Row(
                  children: const [
                    ...
                    Padding(
                      ...
                      child: Text("مرتجع مشتريات", style: TextStyle(color: titleColor), ),
                    )
                  ],
                ),
                SizedBox(height: 20,),
                Row(
                  ...
                  children:  [
                    ...
                    const Padding(
                      padding: EdgeInsets.all(8.0),
                      child: Text("*اسم المورد", style: TextStyle(color: titleColor),),
                    ),
                    SizedBox(width: 50,),
                const     SizedBox(
                      width: 140,

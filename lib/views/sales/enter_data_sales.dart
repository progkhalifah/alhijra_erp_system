...
class EnterDataSalesPage extends StatelessWidget {
  EnterDataSalesPage({Key? key}) : super(key: key);
                ...
                Row(
                  children: const [
                    ...
                    Padding(
                      ...
                      child: Text("إدخال بيانات مبيعات", style: TextStyle(color: titleColor), ),
                    )
                  ],
                ),
                SizedBox(height: 20,),

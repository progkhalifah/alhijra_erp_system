...
class CustomeAppBarInventoryManager extends StatelessWidget {
  const CustomeAppBarInventoryManager({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var role_name = "مدير مخزن";

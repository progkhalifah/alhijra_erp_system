...
class PagePrescription extends StatelessWidget {
  PagePrescription({Key? key}) : super(key: key);
              ...
              children: [
                Row(
                  children: const [
                    ...
                    Padding(
                      ...
                      child: Text("إدخال وصفة طبية", style: TextStyle(color: titleColor), ),
                    )
                  ],
                ),
                SizedBox(height: 20,),
                ...
                Row(
                  ...
                  children:  [
                    ...
                    const Padding(
                      padding: EdgeInsets.all(8.0),
                      child: Text("* نوع الدواء", style: TextStyle(color: titleColor),),
                    ),
                    SizedBox(width: 50,),
                    Container(
                      width: 120,
                    ...
                    const Padding(
                      padding: EdgeInsets.all(8.0),
                      child: Text("* نوع المرض", style: TextStyle(color: titleColor),),
                    ),
                  ],
                ),
